...
def my_stats(slis):
    ...
    print("Mean: ", np.mean(slis))
    print("Median: ", np.median(slis))
    print("Mode: ", stats.mode(slis))    
#    try:
#        print("Mode: ", statistics.mode(slis))
#    except statistics.StatisticsError as e:
#        print("Mode error: ", e)
    print("Standard Deviation: ", np.std(slis))
    print("Variance: ", np.var(slis))
